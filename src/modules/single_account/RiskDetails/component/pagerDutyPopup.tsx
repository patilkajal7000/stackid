...
function PagerDutyPopup({ show, handleSave, handleClose, riskDetails, cloudAccountId }: GraphPopoverProps) {
    return (
        <>
            <CModal visible={show} size="lg" onClose={handleClose}>
                <CModalHeader closeButton>
                    <CModalTitle>Send BPI Risk Details to PagerDuty</CModalTitle>
                </CModalHeader>
                <CModalBody>
